<?php /* アイコン */?>
<nav id="headerArea">
    <a href="top.php"><img src="img/aisai_m_league.jpg"></a>
</nav>
...
<?php /* メニュー */ ?>
<div id="popupMenu">
    <a href="top.php"><div class="header-button">トップ</div></a>
    <div class="before-line"></div>
    <a href="stats.php"><div class="header-button">成績</div></a>
    <a href="stats_individual.php"><div class="header-button">個人成績</div></a>
    <div class="before-line"></div>
    <a href="add.php"><div class="header-button">登録</div></a>
    <a href="history.php"><div class="header-button">履歴</div></a>
    <div class="before-line"></div>
    <a href="analysis.php"><div class="header-button">AI分析</div></a>
</div>

<?php if($dbServerNumber == 2): ?>
    <div class="header_area" style="height: 60px;"></div>
<?php endif; ?>
