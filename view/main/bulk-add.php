...
/**
 * 一括登録ページビュー。
 * 1半荘分の4席データをまとめて入力し、合計点や自動順位をクライアント側でも補助表示する。
 */
$initialScoreTotal = 0;
...
<main>
    ...
    <div class="form-container container">
        <form id="bulkAddForm" action="bulk-add" method="post" class="registration-form">
    ...
    <button class="submit-button btn-primary" type="submit" form="bulkAddForm">一括登録する</button>
</main>
