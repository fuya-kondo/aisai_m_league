    ...
    <div class="p-rule__body">
        ...
        <h3 class="c-title">
            ...
            <div class="p-rule__contents">
                ...
                <p class="p-rule__text">自動配牌機能を使用する。</p>
        ...
        <section class="p-rule__group">
            ...
            <div class="p-rule__contents">
                ...
                <p class="p-rule__text">各試合の座位（東家・南家・西家・北家）はシーズンを通して定められており、出場選手は該当場所に着座する。東家の者がそのまま起家となる。但しファイナルシリーズでは、最終戦を迎えた時点でチームポイントの少ない方から、東家・南家・西家・北家の座位となる。</p>
        ...
        <section class="p-rule__group">
            ...
            <div class="p-rule__contents">
                ...
                <ol class="p-rule__text">
                    <li>罰はチョンボ・アガリ放棄・イエローカード・レッドカードの4種とする。</li>
                ...
                <ol class="p-rule__text">
                    ...
                    （2）先ヅモ <br>
                    ・上家の打牌前にツモを行った、と審判が判断した場合はアガリ放棄となる。<br>
                    （3）食い換え<br>
                ...
                <ol class="p-rule__text">
                    ...
                    <li>錯チー・錯ポン・錯カンはアガリ放棄とする。</li>
                    <li>チー・ポン・カンは非成立とし、指示牌を持ってきた場合は元に戻す。</li>
                    <li>副露した牌が2枚以上あった場合は、第7条-5-2 で定められる見せ牌の対象となり、重ねてイエローカードが提示される。</li>
                </ol>
                <h4 class="c-title -dot">第4条 チョンボとその対象</h4>
                <ol class="p-rule__text">
                    <li>全てのチョンボ該当者は自己のトータルポイントから20ポイントを減算される。（親・子には関わらない）</li>
                    <li>以下の行為をチョンボとする。<br>
                    ...
                    <li>審判に故意と認められたチョンボを行なった場合は、罰則のポイントを三倍とし、出場資格が問われる</li>
                    <li>チョンボ時に正当なアガリがあれば、その罰を免れる。</li>
                    <li>チョンボ者が複数の場合、全て罰を受ける。</li>
                    <li>チョンボがあった局は、チョンボ者が親・子にかかわらず、その局をやり直す。(積み棒は増えない)</li>
                </ol>
                <h4 class="c-title -dot">第5条 カードとその対象</h4>
                <ol class="p-rule__text">
                    <li>アガリ放棄及びチョンボには至らないものの、以下に定める項目に該当する場合や、第1章7条1における義務を対局者が怠っている場合等に、審判よりイエローカードが提示される。</li>
                    <li>提示のタイミングは、発生した局の終了時点とする。</li>
                    <li>イエローカードは当日のみ累積し、1日2枚でレッドカードが提示される。</li>
                    <li>レッドカードが提示された者は、チョンボと同様の罰則（個人トータルポイントから20ポイントを減算）を受ける。</li>
                    <li>以下の行為がイエローカード対象とする。<br>
                    （1）発声行為を黙って行った、と審判が判断した場合。動作が先で、発声が明らかに遅れた場合も同じである。<br>
                    （2）故意とは認められないものの、2枚以上の見せ牌をした場合（山・手牌共通）<br>
                    （3）局面と関係ない場面での強打・長考が度重なる場合。<br>
                    （4）牌を絞ってツモる、振りかぶってツモるなど、時間が掛かるツモの動作が度重なる場合。<br>
                    （5）小手返しや、ツモ牌を手牌の中に入れる行為が度重なる場合。<br>
                    （6）ツモり出しが早く、正当なポン・カンがあった際に、ツモ牌を認識していることが度重なる場合。<br>
                    （7）過度なため息やぼやきなど、相手を惑わす可能性がある言動が度重なる場合。<br>
                    </li>
                </ol>
