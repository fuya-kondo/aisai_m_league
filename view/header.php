...
<div class="header_area">
    ...
    <?php /* メニュー */ ?>
    <div id="popupMenu">
        <a href="<?= h($baseUrl) ?>/top"><div class="header-button">AISAI.M.LEAGUE</div></a>
        <div class="before-line"></div>
        <a href="<?= h($baseUrl) ?>/stats"><div class="header-button">全体成績</div></a>
        ...
        <div class="before-line"></div>
        <!-- <a href="<?= h($baseUrl) ?>/analysis"><div class="header-button">AI成績分析</div></a>
        <div class="before-line"></div> -->
        <a href="<?= h($baseUrl) ?>/sound"><div class="header-button">発声</div></a>
        <div class="before-line"></div>
        <a href="<?= h($baseUrl) ?>/setting"><div class="header-button">設定</div></a>
    </div>
